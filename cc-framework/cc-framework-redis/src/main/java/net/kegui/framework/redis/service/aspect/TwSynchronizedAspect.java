package net.kegui.framework.redis.service.aspect;

import net.kegui.framework.redis.service.annotation.TwSynchronized;
...
public class TwSynchronizedAspect {
	 ...
	 * 配置织入点
	 */
	@Pointcut("@annotation(net.kegui.framework.redis.service.annotation.TwSynchronized)")
