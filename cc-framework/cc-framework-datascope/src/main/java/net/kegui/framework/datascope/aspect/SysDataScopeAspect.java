package net.kegui.framework.datascope.aspect;

import net.kegui.api.system.domain.SysRole;
import net.kegui.framework.core.application.domain.BaseEntity;
...
public class SysDataScopeAspect {
	 ...
	 * 配置织入点
	 */
	@Pointcut("@annotation(net.kegui.framework.datascope.annotation.SysDataScope)")
