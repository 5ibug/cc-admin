package net.kegui.auth.support.core;

import net.kegui.auth.config.CustomOAuth2UserService;
import net.kegui.auth.support.handler.FormAuthenticationFailureHandler;
import net.kegui.auth.support.handler.SsoLogoutSuccessHandler;
