package net.kegui.auth.config;

import net.kegui.auth.support.CustomeOAuth2AccessTokenGenerator;
import net.kegui.auth.support.core.CustomOAuth2TokenCustomizer;
import net.kegui.auth.support.core.FormIdentityLoginConfigurer;
import net.kegui.auth.support.core.TWTDaoAuthenticationProvider;
import net.kegui.auth.support.handler.TWTAuthenticationFailureEventHandler;
import net.kegui.auth.support.handler.TWTAuthenticationSuccessEventHandler;
import net.kegui.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import net.kegui.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import net.kegui.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationConverter;
import net.kegui.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationProvider;
